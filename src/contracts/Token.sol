...
contract Token {
    ...
    /// variables for name of token, symbol, decimals aligned with ETH and the totalSupply that define a token
    string public name       = "Arcadios Token";
